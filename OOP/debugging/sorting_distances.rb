...
# necessary changes to our code so that the various lengths
...
# Added a #- method to class
test1 = Length.new(1, :mi)
test2 = Length.new(1, :mi).as_nautical_miles
puts (test1 - test2).abs < 0.001